...
from scraper import *
from DatabaseManager import DatabaseManager  # the class we just wrote

class StatareaCompounder:
	def __init__(self, future_days=5, update_scores_days=3, db_path="statarea_ml_compounder.db"):
		self.scraper = StatareaScraper()  # make sure to instantiate it
...
if __name__ == "__main__":
	StatareaCompounder().compound_daily()
